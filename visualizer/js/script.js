...
/* Lets users choose which x-value they'd like to use */
function chooseXAxis () {
  // need work!
  return 'numInstructions'
}

/* Lets users choose which y-value they'd like to use */
function chooseResource () {
  // need work!
  return 'cache'
}

/* This function will take the raw array and a string of the specified resource
and categorized them into cache, power, branchPredictor, etc */
...
/* Makes an array of density information and "fake" xAxis and yAxis
information */
function densityInfo (timeslices) {
  /* for now, just take in missRates and instructionsAcc */
